...
//      MensajeErr("C¾digo de Caja ["+cCodCaja+"] no Existe, Serß Asumido el C¾digo de Caja: "+oDp:cCaja+CRLF+;
...
//VIEWARRAY(aGrupo)
  ...
  oPos:oBtnPagUp:cToolTip:="Pßgina Siguiente"
 ...
 @ 3.0, 230  SBUTTON oPos:oBtnPagEle PIXEL;
             SIZE 20,28 FONT oFontB;
             FILE "BITMAPS\IVA10%.BMP";
             COLORS CLR_BLACK, { CLR_WHITE, CLR_GRAY, 1 };
             ACTION oPos:SETIVA10()

  oPos:oBtnPagEle:cToolTip:="Venta con Pago Electrónico"


 @ 3.0, 260  SBUTTON oPos:oBtnExit PIXEL;
             SIZE 20,28 FONT oFontB;
...
FUNCTION PAGBARRA()
  ...
  @23.2, 70 STSAY oPos:oCodText PROMPT "Código  F6";
