...
PROCE MAIN(lVenta)
   ...
   // JN 18/11/2022, imprimirá segun documento almacenados
...
//   ENDIF
   ...
   // Cuando la Impresora no está fiscalizada esta función Genera Error
   cCupon:=SPACE(06)
   ...
   IF !oPos:lImpErr
    ...
    ELSE
       ...
       oPos:SetMsgInv("Cupon Fiscal Generó Error")
