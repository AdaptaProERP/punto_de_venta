...
// Propæsito  : Iniciaciæn del Punto de Venta
...
// 17/11/2023 No necesita validar la impresora fiscal
   ...
   IF SQLGET("DPTABXUSU","TXU_CODUSU","TXU_CODUSU"+GetWhere("=",oDp:cUsuario)+" AND "+;
     ...
     MensajeErr("Usuario "+oDp:cUsuario+" no estﬂ Autorizado para el PC "+oDp:cIpLocal+CRLF+;
...
*/
   ...
   // Buscamos el Ultimo dia Trabajado, para verificar si realizæ reporte Zeta.
...
/* Inabilitadas
   ...
   IF UPPER(LEFT(oDp:cImpFiscal,ancho))$"ACLAS,BEMATECH,BMC,EPSON,SAMSUNG,OKIDATA"
       ...
       IF MYSQLGET("DPAUDITOR","AUD_CLAVE","AUD_CLAVE"  +GetWhere("=",oDp:cImpFiscal  )+" AND "+;
          ...
          MensajeErr("Este PC "+oDp:cPcName+" ya Ejecutæ el Reporte Zeta para la Impresora "+oDp:cImpFiscal+;
