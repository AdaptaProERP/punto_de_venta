...
FUNCTION MAIN(lDely,cPedido)
  LOCAL oBtn,oTable,oGet,oFont,oFontB,oFontG,oScript,oCursor
  ...
  DEFAULT oDp:cUndMedPos:=NIL

  IF Empty(oDp:cUndMedPos)
     MensajeErr("Requiere Definición del POS")
     EJECUTAR("DPPOSDEF")
     RETURN .F.
  ENDIF
  ...
  IF lDely
    ...
    // AEVAL(aZona,{|a,n|AADD(aTarifa,a[2]),aZona[n]:=a[1]})
     ...
     IF Empty(aZona)
        AADD(aZona,{"Indefinido",0,"Indefinido"})
     ENDIF
  ...
  ELSE
     ...
     DEFINE FONT oFontG NAME "Tahoma" SIZE 0, -13
  ...
  IF Empty(cMesero)
     cMesero:=MYSQLGET("DPVENDEDOR","VEN_CODIGO","VEN_CODIGO"+GetWhere("<>","")+" AND 1=1 LIMIT 1")
  ENDIF
  ...
  oTable   :=OpenTable(cSql,.F.) //"WHERE"$cSql) // nOption!=1)
 ...
 // oPOSCOMANDA:=DPEDIT():New(cTitle,"DPPOSCOMANDA"+IIF(lDely,"D","")+oDp:cModeVideo+".edt","oPOSCOMANDA" , .F. )
  ...
  DpMdi(cTitle,"oPOSCOMANDA","DPPOSCOMANDA.edt")
  oPOSCOMANDA:Windows(0,0,aCoors[3]-160,MIN(1748,aCoors[4]-10),.T.) // Maximizado
  ...
  oPOSCOMANDA:lBarDef   :=.T. // 
  oPOSCOMANDA:lLlevar   :=.F.
  oPOSCOMANDA:lDely     :=lDely
  oPOSCOMANDA:LPAGELE   :=.F.  // Pago electrónico
  ...
  oPOSCOMANDA:aUndMed   :={oDp:cUndMedPos}
  oPOSCOMANDA:CLIZERO()
  ...
  oPOSCOMANDA:cMunici   :=IF(lDely,aMuni[1],"") // SPACE(40)
  oPOSCOMANDA:cZona     :=IF(lDely,aZona[1],"") // SPACE(40)
...
//     @ 1,1 GET oPOSCOMANDA:oDirE3 VAR oPOSCOMANDA:cDirE3 WHEN oPOSCOMANDA:oZona:nAt>1 .AND. ALLTRIM(oPOSCOMANDA:cRif )<>"0"
  ...
  @ 1.0, 1.0 BMPGET oPOSCOMANDA:oCOM_CODIGO  VAR oPOSCOMANDA:COM_CODIGO ;
             VALID oPOSCOMANDA:COMCODIGO();
                    NAME "BITMAPS\FIND.BMP"; 
                    ACTION (oDpLbx:=DpLbx("DPINVCOMANDA.LBX",NIL,"INV_LISTA"+GetWhere("=",oDp:cPrecioPos),NIL,NIL,NIL,NIL,NIL,NIL,oPOSCOMANDA:oCOM_CODIGO),;
                            oDpLbx:GetValue("INV_CODIGO",oPOSCOMANDA:oCOM_CODIGO)); 
  ...
  oPOSCOMANDA:oCOM_CODIGO:bKeyDown:={|nKey| IIF(nKey=13, oPOSCOMANDA:COMCODIGO(),NIL)}
 ...
 @ 3, 0 COMBOBOX oPOSCOMANDA:oCOM_UNDMED  VAR oPOSCOMANDA:COM_UNDMED ITEMS oPOSCOMANDA:aUndMed;
        FONT oFontG;
        SIZE 32,10;
        ON CHANGE oPOSCOMANDA:COMUNDMED();
        WHEN LEN(oPOSCOMANDA:oCOM_UNDMED:aItems)>1

  oPOSCOMANDA:oCOM_UNDMED:cMsg    :="Unidad de Medida"
  oPOSCOMANDA:oCOM_UNDMED:cToolTip:="Unidad de Medida"
  ...
  oPOSCOMANDA:oCOM_CANTID:bKeyDown:={|nKey| IIF(nKey=13, oPOSCOMANDA:COMCANTID(),NIL)}
  ...
  @ 0,0 SAY "Comentarios" PIXEL;
   ...
   IF Empty(aData)
     AADD(aData,aLine) // {"","","","","",0,"","",0})
   ENDIF

   oPOSCOMANDA:oBrw:=TXBrowse():New( oPOSCOMANDA:oWnd )
...
//  oPOSCOMANDA:oBrw:lFooter     := .F.
   ...
   oPOSCOMANDA:aLine    :=ACLONE(aLine)
   ...
   oCol:nWidth       :=180+4+iif(Empty(oDp:cModeVideo),0,80)+30

   oCol:=oPOSCOMANDA:oBrw:aCols[3]
   oCol:cHeader      :="Mesa"
   oCol:nWidth       :=34+2+iif(Empty(oDp:cModeVideo),0,40)-30

   oCol:=oPOSCOMANDA:oBrw:aCols[4]
   oCol:cHeader      :="Mesero"
   oCol:nWidth       :=60+iif(Empty(oDp:cModeVideo),0,40)-35

   oCol:=oPOSCOMANDA:oBrw:aCols[5]
   oCol:cHeader      :="Nombre del Mesero"
   oCol:nWidth       :=156-50+iif(Empty(oDp:cModeVideo),0,30)-40
   ...
   oCol:cHeader      :="Cant."
   oCol:nWidth       :=50 // 100+iif(Empty(oDp:cModeVideo),0,15)
   ...
   oPOSCOMANDA:oBrw:bClrHeader            := {|| { oDp:nLbxClrHeaderText, oDp:nLbxClrHeaderPane}}
   oPOSCOMANDA:oBrw:bClrFooter            := {|| { oDp:nLbxClrHeaderText, oDp:nLbxClrHeaderPane}}


   oCol:=oPOSCOMANDA:oBrw:aCols[7]
   oCol:cHeader      :="Unidad"
   oCol:nWidth       :=44+20 //+iif(Empty(oDp:cModeVideo),0,50)
...
//     oPOSCOMANDA:oBrw:DelCol(9)
   ...
   oPOSCOMANDA:oWnd:oClient := oPOSCOMANDA:oBrw


   @ 0,40 SAY "Unidad" PIXEL;
          SIZE NIL,7 FONT oFont COLOR nClrText,oDp:nGris
...
FUNCTION INICIO()
   ...
   LOCAL oDlg:=oPOSCOMANDA:oDlg
   LOCAL oCursor,oBar,oBtn,oFont,oCol
   LOCAL oDlg:=oPOSCOMANDA:oWnd
   LOCAL nLin:=0
   LOCAL nWidth:=oPOSCOMANDA:oBrw:nWidth()
   ...
   DEFINE BUTTONBAR oBar SIZE 52-15,100+100 OF oDlg 3D CURSOR oCursor
   ...
   DEFINE BUTTON oBtn;
          ...
          ACTION ACTION (oPOSCOMANDA:Save())
   ...
   DEFINE BUTTON oBtn;
          ...
          FILENAME "BITMAPS\XEDIT.BMP","BITMAPS\XEDIT.BMP","BITMAPS\XEDITG.BMP";
          WHEN ISTABMOD("DPPOSCOMANDA");
          ACTION (oPOSCOMANDA:Modificar()) CANCEL
   ...
   oBtn:lCancel :=.T.
   oBtn:cToolTip:="Componentes o Contornos"
   oBtn:cMsg    :=oBtn:cToolTip
   ...
   ELSE
     ...
     DEFINE BUTTON oBtn;
            ...
            FONT oFont;
            TOP PROMPT "Pedidos";
            FILE "BITMAPS\pedidoventa.BMP";
            WHEN .T.;
            ACTION oPOSCOMANDA:SELMESA() CANCEL

     oBtn:lCancel :=.T.
     oBtn:cToolTip:="Pedidos"
     oBtn:cMsg    :=oBtn:cToolTip
   ...
   DEFINE BUTTON oBtn;
          ...
          FONT oFont;
          TOP PROMPT "POS";
          FILE "BITMAPS\POS.BMP";
          WHEN .T.;
          ACTION EJECUTAR("DPPOS01") CANCEL

   oBtn:lCancel :=.T.
   oBtn:cToolTip:="Punto de Venta"
   oBtn:cMsg    :=oBtn:cToolTip
   ...
   IF oPOSCOMANDA:lDely
     ...
     DEFINE BUTTON oBtn;
            ...
            FONT oFont;
            TOP PROMPT "Ruta";	
            FILE "BITMAPS\guiacargadelivery.BMP";
            WHEN .T.;
            ACTION EJECUTAR("DPPOSCMDENVIA") CANCEL
   ...
   DEFINE BUTTON oBtn;
          ...
          FONT oFont;
          TOP PROMPT "Delivery";
          FILENAME "BITMAPS\delivery.BMP",NIL,"BITMAPS\deliveryG.BMP";
          WHEN oDp:lDelivery;
          ACTION EJECUTAR("DPPOSCOMANDA",.T.) CANCEL

   oBtn:lCancel :=.T.
   oBtn:cToolTip:="Delivery"
   oBtn:cMsg    :=oBtn:cToolTip
   ...
   DEFINE BUTTON oBtn;
          ...
          FONT oFont;
          TOP PROMPT "Quitar";
          FILENAME "BITMAPS\XDELETE.BMP","BITMAPS\XDELETE.BMP","BITMAPS\XDELETEG.BMP";
          ACTION oPOSCOMANDA:Quitar()
   ...
   oPOSCOMANDA:SETBTNBAR(40+20,40+20,oBar)
...
//? oPOSCOMANDA:nOption,"oPOSCOMANDA:nOption"
...
FUNCTION COMCODIGO()
   ...
   aUnd:=ASQL(" SELECT PRE_UNDMED,PRE_PRECIO FROM DPPRECIOS "+;
              " INNER JOIN DPUNDMED ON PRE_UNDMED=UND_CODIGO "+;
              " WHERE PRE_CODIGO"+GetWhere("=",oPOSCOMANDA:COM_CODIGO)+" AND "+;
                                                           "PRE_LISTA "+GetWhere("=",oDp:cPrecioPos        )+" AND "+;
                                                           "PRE_CODMON"+GetWhere("=",oDp:cCodMonPos        )+" AND "+;
                                                           "PRE_PRECIO>0"+ ;
              " ORDER BY UND_CANUND ")
...
/*
   ...
   aUnd:=ASQL(" SELECT PRE_UNDMED,PRE_PRECIO FROM DPPRECIOS "+;
              " LEFT JOIN DPUNDMED ON PRE_UNDMED=UND_CODIGO "+;
              " WHERE PRE_CODIGO"+GetWhere("=",oPOSCOMANDA:COM_CODIGO)+" AND "+;
                                                           "PRE_LISTA "+GetWhere("=",oDp:cPrecioPos        )+" AND "+;
                                                           "PRE_CODMON"+GetWhere("=",oDp:cCodMonPos        )+" AND "+;
                                                           "PRE_PRECIO>0"+ ;
...
//? CLPCOPY(oDp:cSql)
   ...
   AEVAL(aUnd,{|a,n|aUnd[n]:=a[1]})

   oPOSCOMANDA:COM_UNDMED:=oDp:cUndMedPos

   IF Empty(aUnd)
      aUnd:={}
      AADD(aUnd,oDp:cUndMedPos)
   ENDIF

   IF LEN(aUnd)>0
     oPOSCOMANDA:oCOM_UNDMED:SetItems(aUnd)
     oPOSCOMANDA:oCOM_UNDMED:Select(1) // =aUnd[1]
   ENDIF

   COMBOINI(oPOSCOMANDA:oCOM_UNDMED)
...
// oPOSCOMANDA:COM_DESCRI:=cDescri
   ...
   // Busca la Unidad de Medida en el precio


   cUndMed:=SQLGET("VIEW_DPINVCOMANDAS","INV_UNDMED,INV_PRECIO","INV_CODIGO"+GetWhere("=",oPOSCOMANDA:COM_CODIGO))
// ? cUndMed
// ViewArray(aUnd)
/*
//? cUndMed,"cUndmed"
...
*/
   ...
   nPrecio:=DPSQLROW(2,0)

   oPOSCOMANDA:COM_UNDMED:=cUndMed
...
// ? CLPCOPY(oDp:cSql)
   ...
   IF nPrecio<=0 
      ...
      oPOSCOMANDA:oCOM_CODIGO:MsgErr(GetFromVar("{oDp:DPINV}")+" no posee Precio"+CRLF+;
...
FUNCTION QUITAR()
  ...
  LOCAL cWhere :="COM_MESERO"+GetWhere("=",aData[4])+" AND "
...
// RETURN .T.
  ...
  IF MsgNoYes("Desea Borrar Comanda "+aData[7],"Seleccione Opción")
     ...
     IF Empty(oPOSCOMANDA:oBrw:aArrayData)
       ...
       AADD(oPOSCOMANDA:oBrw:aArrayData,oPOSCOMANDA:aLine) // {"","","","","",0,"","",0,""})
...
FUNCTION BorrarMesa(cMesa)
  ...
  IF Empty(oPOSCOMANDA:oBrw:aArrayData)
    ...
    AADD(oPOSCOMANDA:oBrw:aArrayData,oPOSCOMANDA:aLine) // {"","","","","",0,"",""})
    oPOSCOMANDA:oBrw:Gotop(.T.)
    oPOSCOMANDA:oBrw:Refresh(.T.)
...
FUNCTION SAVECOMP(nOption)
  LOCAL oTable,aData,I,cLpt,cDescri,cItem,nPorIva:=0
  ...
  FOR I=1 TO LEN(aData)
    ...
    nPorIva:=EJECUTAR("IVACAL",aData[I,1],2,oDp:dFecha) // IVA (Nacional o Zona Libre
    ...
    oTable:Replace("COM_IVA"   ,nPorIva   )

//? nPorIva,"nPorIva",aData[I,1]
...
FUNCTION COMUNDMED()
  ...
  IF !Empty(oPOSCOMANDA:COM_UNDMED)

       oPOSCOMANDA:COM_PRECIO:=MYSQLGET("DPPRECIOS","PRE_PRECIO","PRE_CODIGO"+GetWhere("=",oPOSCOMANDA:COM_CODIGO)+" AND "+;
                                        "PRE_UNDMED"+GetWhere("=",oPOSCOMANDA:COM_UNDMED)+" AND "+;
                                        "PRE_LISTA "+GetWhere("=",oDp:cPrecioPos        )+" AND "+;
                                        "PRE_CODMON"+GetWhere("=",oDp:cCodMonPos        ))
  ENDIF
